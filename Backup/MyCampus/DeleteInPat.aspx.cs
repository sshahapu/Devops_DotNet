...
namespace MyCampus
{
    public partial class DeleteInPat : System.Web.UI.Page
    {
        ...
        protected void gvbind()
        {
            ...
            else
            {
                ...
                Lblmessge.Text = "no records to delete.";
        ...
        protected void deleteRow(object sender, GridViewDeleteEventArgs e)       //function to delete selected row
        {
            try
            {
                ...
                if (adm.deleteInPat(patid))
                {
                    messagediv.Visible = true;
                    Lblmessge.Text = "In Patient " + patid + " deleted successfully!";
                    gvbind();
                }
                else
                {
                    messagediv.Visible = true;
                    Lblmessge.Text = "no records deleted, please try again";
