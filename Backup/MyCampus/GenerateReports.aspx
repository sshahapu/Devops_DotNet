<%@ Page Title="" Language="C#" MasterPageFile="~/Admin1.Master" AutoEventWireup="true" CodeBehind="GenerateReports.aspx.cs" Inherits="MyCampus.GenerateReports" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="Label17" runat="server" ForeColor="Red" Text="*"></asp:Label>
                ...
                <asp:TextBox ID="TextBox8" runat="server" TextMode="MultiLine" MaxLength="200" 
                    Height="50px" ValidationGroup="saverrors" Width="154px"></asp:TextBox>
            </td><td class="style2">
        ...
        <td>
            <asp:Button ID="Button9" runat="server" Enabled="False" onclick="Button9_Click" 
                Text="Generate Reports" ValidationGroup="saverrors" Width="142px" />
            </td><td>
