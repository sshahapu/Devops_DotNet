<%@ Page Title="" Language="C#" MasterPageFile="~/Admin1.Master" AutoEventWireup="true" CodeBehind="SearchInPatient.aspx.cs" Inherits="MyHospital.SearchInPatient" %>
...
<HeaderStyle BackColor="#465c71"></HeaderStyle>
          ...
          <asp:HyperLinkField  datanavigateurlfields="patid" 
            DataNavigateUrlFormatString="~\InRegistration.aspx?patid={0}" Text="Edit" 
