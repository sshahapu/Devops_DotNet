<%@ Page Title="" Language="C#" MasterPageFile="~/Operator.Master" AutoEventWireup="true" CodeBehind="OutRegistration_oper.aspx.cs" Inherits="MyCampus.OutRegistration_oper" %>
...
&nbsp;</td><td>
    <asp:DropDownList ID="PGender" runat="server" Width="150px">
...
<tr><td>
    ...
    <asp:Label ID="Label17" runat="server" ForeColor="Red" Text="*"></asp:Label>
        ...
        <asp:DropDownList ID="DropDownList1" runat="server" 
            ...
            DataValueField="Department" Width="154px" 
