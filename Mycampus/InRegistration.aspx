<%@ Page Title="" Language="C#" MasterPageFile="~/Admin1.Master" AutoEventWireup="true" CodeBehind="InRegistration.aspx.cs" Inherits="MyHospital.InRegistration" %>
...
<tr><td>
    &nbsp;&nbsp;<asp:Label ID="Label5" runat="server" Text="Adress"></asp:Label>
        ...
        <asp:TextBox ID="Padress" runat="server" TextMode="MultiLine" Width="154px"></asp:TextBox>
...
<tr><td>
    ...
    <asp:Label ID="Label16" runat="server" ForeColor="Red" Text="*"></asp:Label>
        ...
        <asp:DropDownList ID="DropDownList1" runat="server" 
            ...
            DataValueField="room_no" Width="159px">
        </asp:DropDownList>
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT DISTINCT room_no FROM room_details WHERE (room_no NOT IN (SELECT roomno FROM Patient_details WHERE (roomno IS NOT NULL)))">
        </asp:SqlDataSource>
    </td><td class="style1">
...
<div style="background-color:#4b6c9e; width: 557px; margin-left: 0px;" 
